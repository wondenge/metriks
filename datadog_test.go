...
func TestDatadog(t *testing.T) {
	...
	datadogRegistry := RegisterDatadog(context.Background(), &Datadog{Address: ":18125", PushInterval: Duration(time.Second), AddEntryPointsLabels: true, AddServicesLabels: true})
	defer StopDatadog()
