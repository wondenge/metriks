...
func TestStatsD(t *testing.T) {
	...
	statsdRegistry := RegisterStatsd(context.Background(), &Statsd{Address: ":18125", PushInterval: Duration(time.Second), AddEntryPointsLabels: true, AddServicesLabels: true})
	defer StopStatsd()
...
func TestStatsDWithPrefix(t *testing.T) {
	...
	statsdRegistry := RegisterStatsd(context.Background(), &Statsd{Address: ":18125", PushInterval: Duration(time.Second), AddEntryPointsLabels: true, AddServicesLabels: true, Prefix: "testPrefix"})
	defer StopStatsd()
