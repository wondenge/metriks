...
import (
	...
	"github.com/wondenge/metriks/safe"
...
func RegisterInfluxDB(ctx context.Context, config *InfluxDB) Registry {
...
func initInfluxDBClient(ctx context.Context, config *InfluxDB) *influx.Influx {
...
func initInfluxDBTicker(ctx context.Context, config *InfluxDB) *time.Ticker {
